...
namespace MvcTienda_Aaron.Controllers
{
    public class DetallesController : Controller
    {
        ...
        public DetallesController(MvcTienda_AaronContexto context)
        {
            _context = context;
        }
        ...
        {
            var mvcTienda_AaronContexto = _context.Detalles.Include(d => d.Pedido).Include(d => d.Producto);
        ...
        public async Task<IActionResult> DeleteConfirmed(int id)
        {
            ...
            {
                return Problem("Entity set 'MvcTienda_AaronContexto.Detalles'  is null.");
            }
            var detalle = await _context.Detalles.FindAsync(id);
            if (detalle != null)
            {
