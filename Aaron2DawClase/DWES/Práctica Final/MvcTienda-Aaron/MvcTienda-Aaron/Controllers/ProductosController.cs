...
namespace MvcTienda_Aaron.Controllers
{
    public class ProductosController : Controller
    {
        ...
        public ProductosController(MvcTienda_AaronContexto context, IWebHostEnvironment webHostEnvironment)
        {
            _context = context;
        ...
        public async Task<IActionResult> Create([Bind("Id,Descripcion,Texto,Precio,PrecioCadena,Escaparate,Imagen,CategoriaId")] Producto producto)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Id,Descripcion,Texto,Precio,PrecioCadena,Escaparate,Imagen,CategoriaId")] Producto producto)
        {
            if (id != producto.Id)
            {
                return NotFound();
        ...
        public async Task<IActionResult> CambiarImagen(int? id, IFormFile imagen)
        {
            ...
            if (ModelState.IsValid)
            {
                ...
                string strRutaImagenes = Path.Combine(_webHostEnvironment.WebRootPath, "images");
        ...
        public async Task<IActionResult> DeleteConfirmed(int id)
        {
            ...
            {
                return Problem("Entity set 'MvcTienda_AaronContexto.Productos'  is null.");
            }
            var producto = await _context.Productos.FindAsync(id);
            if (producto != null)
            {
