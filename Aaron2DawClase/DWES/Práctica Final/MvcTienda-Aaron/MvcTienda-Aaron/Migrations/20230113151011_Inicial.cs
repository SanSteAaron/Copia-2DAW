    ...
    public partial class Inicial : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_ProductosTalla", x => x.Id);
                    table.ForeignKey(
                        name: "FK_ProductosTalla_Productos_ProductoId",
                        column: x => x.ProductoId,
                        principalTable: "Productos",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_ProductosTalla_Talla_TallaId",
                        column: x => x.TallaId,
            ...
            migrationBuilder.CreateIndex(
                name: "IX_ProductosTalla_ProductoId",
                table: "ProductosTalla",
                column: "ProductoId");

            migrationBuilder.CreateIndex(
                name: "IX_ProductosTalla_TallaId",
                table: "ProductosTalla",
                column: "TallaId");
        }
