    ...
    <form id="form1" runat="server">
        ...
        <div class="Contenido">
            ...
            <div>
                ...
                <asp:RegularExpressionValidator ID="regTxtCodEmp" ForeColor="Green" ValidationExpression="\w\d{5}" ControlToValidate="txtCodEmp" runat="server" ErrorMessage="El formato introducido debe ser una letra y 5 dígitos"></asp:RegularExpressionValidator>
            </div>
            <div>
                ...
                <asp:RegularExpressionValidator ID="regTxtNifEmp" ForeColor="Green" ValidationExpression="\d{8}-\w" ControlToValidate="txtNifEmp" runat="server" ErrorMessage="El formato introducido debe ser 8 dígitos, un guión y una letra"></asp:RegularExpressionValidator>
            </div>
            <div>
            ...
            <div>
                ...
                <asp:CompareValidator ID="cmpTxtFnaEmp" ControlToValidate="txtFnaEmp" ControlToCompare="txtFinEmp" runat="server" ForeColor="Red" Type="Date" Operator="LessThan" ErrorMessage="La Fecha de Ingreso del Empleado debe ser mayor que la Fecha de Nacimiento"></asp:CompareValidator>
                <asp:RegularExpressionValidator ID="regTxtFnaEmp" ForeColor="Green" ValidationExpression="\d\d\/\d\d\/\d\d\d\d" ControlToValidate="txtFnaEmp" runat="server" ErrorMessage="El formato introducido debe ser dd/mm/aaaa"></asp:RegularExpressionValidator>
            </div>
            <div>
               ...
               <asp:RegularExpressionValidator ID="regTxtFinEmp" ForeColor="Green" ValidationExpression="\d\d\/\d\d\/\d\d\d\d" ControlToValidate="txtFinEmp" runat="server" ErrorMessage="El formato introducido debe ser dd/mm/aaaa"></asp:RegularExpressionValidator>
            </div>
            <div>
